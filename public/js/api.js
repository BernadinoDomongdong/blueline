...
export const api = {
  ...
  ask(question, graph, credential) {
    return postJSON('/api/ask', { question, graph, credential });
  },
  report(graph, reportType, credential) {
    return postJSON('/api/report', { graph, reportType, credential });
  },
  modelInfo() {
    return getJSON('/api/model-info');
  },
};
